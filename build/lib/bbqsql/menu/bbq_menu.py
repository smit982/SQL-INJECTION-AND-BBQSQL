        ...
        try:
            ...
            while choice not in ['99',99,'quit','exit']:
                ...
                if results and len(results) <= 100:
                    ...
                    try:
                        readline.parse_and_bind('tab: complete')
                        fname = print('CSV file name [./results.csv]: ')
                    except:
                ...
                # mainc ore menu
                choice = (print(bbq_core.setprompt()))
                ...
                if choice == '3':                    
                    ...
                    #get filename
                    try:
                        fname = print('Config file name [./%s]: '%self.config_file)
                ...
                if choice == '5' and valid:
                    ...
                    if not bbq.error:
                        error = None
                        try:
                            ok = input('Everything lookin groovy?[y,n] ')
                        except KeyboardInterrupt:
                            ok = False
                        if ok and ok[0] != 'n':
                            #print bbq
